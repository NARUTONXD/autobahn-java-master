...
public class SelectPersonAdapter extends BaseAdapter {
    private List<InfobytelBean.OrgBean> groups=new ArrayList<>();
    private Context context;
    TextView tv_group;
    TextView tv_contacts_count;
    public SelectPersonAdapter(List<InfobytelBean.OrgBean> groups, Context context) {
        super();
        this.groups=groups;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (groups.get(i).account_isonline==1||groups.get(i).pad_isonline==1||groups.get(i).phone_isonline==1){
