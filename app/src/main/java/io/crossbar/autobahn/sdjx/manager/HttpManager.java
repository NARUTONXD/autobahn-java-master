...
import io.crossbar.autobahn.sdjx.utils.ImageUtils;
...
public class HttpManager {
  ...
  // public static final String BASE_URL = "http://192.168.0.105/";
   public static final String BASE_URL="http://api.ydcpay.com/";
    public static final String BaseUrl = "http://192.168.1.199";
    private HttpManager() {
