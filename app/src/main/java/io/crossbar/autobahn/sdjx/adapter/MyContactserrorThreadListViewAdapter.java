...
public class MyContactserrorThreadListViewAdapter extends BaseAdapter {
    private List<AskConfirBean.MsgBean.StaffBean> groups=new ArrayList<>();
    private Context context;
    TextView tv_group;
    TextView tv_contacts_count;
    public MyContactserrorThreadListViewAdapter(List<AskConfirBean.MsgBean.StaffBean> groups, Context context) {
        super();
        this.groups=groups;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        tv_contact_position.setText(groups.get(i).position_name);
